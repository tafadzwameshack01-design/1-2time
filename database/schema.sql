...
CREATE UNIQUE INDEX IF NOT EXISTS idx_api_usage_source_date ON api_usage(source_name, usage_date);
CREATE INDEX IF NOT EXISTS idx_team_ratings_league   ON team_ratings(league_key);
CREATE UNIQUE INDEX IF NOT EXISTS idx_team_ratings_unique ON team_ratings(team_id, league_key);
